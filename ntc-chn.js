...
var ntc = {
  ...
  name: function (color) {
    ...
    for (var i = 0; i < ntc.names.length; i++) {
      if (color == '#' + ntc.names[i][0]) return ['#' + ntc.names[i][0], ntc.names[i][1], true] // this line can be changed to -- return [ntc.names[i][1]]; if you would like to return only name of the colour
